...
const Icon: any = {
    ...
    Rotate: (props: any) => (<svg onClick={props.onClick} width="28" height="27" viewBox="0 0 28 27" fill="none" >
        ...
        <path d="M21.3246 10.0296C20.1957 7.42525 17.6176 5.60522 14.6176 5.60522C10.8242 5.60522 7.70518 8.51547 7.33813 12.2417" stroke="#716C6C" strokeWidth="1.02515" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M18.2756 10.0295H21.4945C21.737 10.0295 21.9335 9.8314 21.9335 9.58705V6.34253" stroke="#716C6C" strokeWidth="1.02515" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M7.94678 15.9287C9.07567 18.533 11.6538 20.3531 14.6537 20.3531C18.4471 20.3531 21.5662 17.4428 21.9332 13.7166" stroke="#716C6C" strokeWidth="1.02515" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M10.996 15.9287H7.77707C7.53465 15.9287 7.33813 16.1268 7.33813 16.3711V19.6157" stroke="#716C6C" strokeWidth="1.02515" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
    ),
    ...
    CloseX: (props: any) => (<svg onClick={props.onClick} width="18" height="17" viewBox="0 0 18 17" fill="none" >
        <path d="M2 2L15 15" stroke="black" strokeWidth="4" stroke-linejoin="round" />
        <path d="M2 15L16 2" stroke="black" strokeWidth="4" stroke-linejoin="round" />
    </svg>
    ),
